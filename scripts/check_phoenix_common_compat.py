...
# ]
# ///
"""Check that every consumer's declared arize-phoenix-common range admits the version we ship.
...
Run with `uv run --no-project scripts/check_phoenix_common_compat.py`.
"""
...
PACKAGE = "arize-phoenix-common"
REPO_ROOT = Path(__file__).resolve().parent.parent
PROVIDER = REPO_ROOT / "packages" / "phoenix-common" / "pyproject.toml"
CONSUMERS = (
