...
Run by the `phoenix_common_mixed_version` tox environment, which installs the evals version pinned
in requirements/packages/phoenix-common-mixed-version.txt from PyPI. Normal CI never builds this
configuration, because the workspace always supplies the current evals.
"""
...
from phoenix.common.executors import (
    AsyncExecutor,
